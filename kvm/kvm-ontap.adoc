...
|===
| 存储协议 | 目录 | 文件系统 | 净流表 | 逻辑 | 磁盘 | iscsi 


| iscsi直接 | mpath | SMB/CIFS | 是 | 否 | 是 | 否 
...
| 吃豆人 | SMB/CIFS | samba 客户端/cifs-utils 


| smbclient/cifs实用程序 | smbclient/cifs实用程序 | NFS 


| nfs实用程序 | nfs-通用 | nfs实用程序 
|===
