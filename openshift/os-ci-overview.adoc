...
要开始使用Cloud Insights，您必须在 link:https://www.netapp.com/console["NetApp Console"]。有关详细信息，请参阅 link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html["Cloud Insights入门"]
