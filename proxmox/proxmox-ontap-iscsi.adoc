...
NOTE: ONTAP 设备多路径所需的配置已包含在包中。有关详细信息，请参见 link:https://docs.netapp.com/us-en/ontap-sanhost/hu-proxmox-ve-9x.html#step-1-confirm-the-multipath-configuration-for-your-host["Proxmox VE 9.x 上使用 ONTAP 存储的 FCP 和 iSCSI 的 ONTAP 9 文档"]
