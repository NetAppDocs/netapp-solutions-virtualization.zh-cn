...
* link:https://www.netapp.com/blog/vmware-optimize-storage-workloads/["在任何云环境中优化存储和数据密集型 VMware 工作负载"]
* link:https://www.netapp.com/blog/vmware-migrate-workloads-azure/["将存储密集型 VMware 工作负载迁移到 Azure VMware 解决方案？请先阅读此文。"]
