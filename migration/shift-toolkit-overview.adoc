...
* 使用虚拟化迁移工具包 (MTV) 从 VMware ESXi 迁移到 Red Hat OpenShift 虚拟化
...
Shift 工具包可以下载link:https://mysupport.netapp.com/site/tools/tool-eula/netapp-shift-toolkit["此处"]仅适用于 Windows 系统。
