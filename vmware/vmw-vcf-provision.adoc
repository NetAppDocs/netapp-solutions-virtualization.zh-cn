...
[role="lead"]
NetApp ONTAP 存储是 VMware Cloud Foundation (VCF) 管理和工作负载域的理想主存储解决方案。ONTAP 提供高性能、可扩展性、高级数据管理和无缝集成，以提高运营效率和数据保护能力。
...
* link:vmw-vcf-viwld-principal-fc.html["使用 FC 的工作负载域"]
* link:vmw-vcf-viwld-principal-nfs.html["使用 NFS 的工作负载域"]
