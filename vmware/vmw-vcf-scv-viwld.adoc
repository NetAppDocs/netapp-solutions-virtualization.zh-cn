...
TIP: 除了将使用 SCV 进行的备份复制到辅助存储之外，还可以使用NetApp Backup and Recovery for VMs 将数据异地副本复制到三大 (3) 领先云提供商之一的对象存储中。更多信息请参阅此产品/服务介绍。link:https://docs.netapp.com/us-en/data-services-backup-recovery/index.html["NetApp Backup and Recovery文档"] 。
