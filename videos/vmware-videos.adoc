...
[role="lead"]
观看视频和演示，了解 VMware 与NetApp存储解决方案的集成。了解如何使用NetApp ONTAP Tools for VMware vSphere、SnapCenter Plug-in for VMware vSphere、3-2-1 数据保护，以及NetApp如何与 VMware Cloud Foundation 和 VMware vSphere Foundation 协同工作。
...
.Virtual Distributed Switch 上带有 Supervisor 的 VKS
video::4ef64b3c-7a68-41d5-bacf-b4a8012b49f8[panopto,width=360]
.结合 VCF Automation 的 VKS
